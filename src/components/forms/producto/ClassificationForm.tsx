...
const ClassificationForm: React.FC<ClassificationFormProps> = ({
  ...
  return (
    ...
    >
      ...
      {/* Segunda fila: Subcategoría, Variedad, Color, Calibre, Tallos y Precio Total en una sola fila */}
      ...
      : ""
            ...
            {(formData.categoria === "BQT" || formData.categoria === "CBS") && (
              <button
                ...
                className="ml-2 px-2 py-1 rounded bg-pink-500 text-white font-bold text-lg hover:bg-pink-600 focus:outline-none"
